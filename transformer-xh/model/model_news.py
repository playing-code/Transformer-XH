...
class ModelHelper_News(ModelHelper):
...
class Model_News(Model):
    def __init__(self, args, config):
        super(Model_Hotpot, self).__init__(args, config)
        self.network= ModelHelper_News(self.bert_node_encoder, self.args, self.bert_config, self.config_model)
